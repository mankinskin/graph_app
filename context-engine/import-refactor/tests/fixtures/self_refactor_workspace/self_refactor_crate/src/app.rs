...
use crate::core::config::{Config, load_settings, save_settings};
use crate::core::validation::{validate_user_input, ValidationResult, validate_email};
...
impl Application {
    ...
    pub fn register_user(&mut self, email: &str, password: &str, username: &str) -> Result<User, String> {
    ...
    pub fn login_user(&mut self, email: &str) -> Result<Session, String> {
    ...
    pub fn update_user_email(&mut self, user_id: u64, new_email: &str) -> Result<(), String> {
