...
CREATE DATABASE `eng_news_2020_100K`;

USE `eng_news_2020_100K`;
...
LOAD DATA LOCAL INFILE 'eng_news_2020_100K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'eng_news_2020_100K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'eng_news_2020_100K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'eng_news_2020_100K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'eng_news_2020_100K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'eng_news_2020_100K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'eng_news_2020_100K-sources.txt' INTO TABLE sources;
