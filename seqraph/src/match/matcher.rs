...
impl<'g, T: Tokenize + 'g, D: MatchDirection> Matcher<'g, T, D> {
    ...
    //        })
    //}
    pub(crate) fn match_sub_vertex_and_context_with_index(
        &self,
        vertex: &VertexData,
    ...
    pub(crate) fn match_context_with_parent_children(
        ...
        Self::get_best_child_pattern(child_patterns, candidates.iter(), context.as_pattern_view())
