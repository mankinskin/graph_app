    ...
    T: Tokenize + 't,
{
    ...
    pub fn merge_left_split(
        ...
        self.left_merger().merge_split(context, inner)
    }
    pub fn merge_right_split(
        ...
        self.right_merger().merge_split(context, inner)
    }
    ...
    //    &mut self,
    //    splits: Vec<(SplitSegment, Option<SplitSegment>)>,
    //) -> Pattern {
...
mod tests {
    ...
    //    assert_eq!(left, vec![ab], "left");
    //    assert_eq!(right, vec![cd], "right");
    //}
    //#[test]
    //fn merge_split_2() {
    //    let mut graph = Hypergraph::default();
    ...
    //    }
    //    .expect("byz");
    //    assert_eq!(left, vec![xa], "left");
    //    assert_eq!(right, vec![byz], "left");
    //}
}
