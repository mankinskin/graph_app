...
pub trait IndexPartitions: HasSubSplitsMut + TraversableMut {
    //fn index_partitions(
    //    &mut self,
    ...
    //    parts
    //}
    //fn indexed_partition_patterns<'a, P: AsPartition<'a>>(
    //    &mut self,
    //    part: P,
    //) -> Result<JoinedPatterns<P::Range>, Child>
    //    where 'p: 'a
    //{
...
pub trait MergePartitions<'a>: HasSubSplitsMut + TraversableMut + AsBundlingContext<'a> {
    //fn merge_partitions(
    //    &mut self,
    //    offsets: &mut BTreeMap<NonZeroUsize, <Self as HasSubSplits>::Split>,
