...
Bielefeld, 11. Dezember 2023   && \IfFileExists{images/unterschrift.pdf}{\includegraphics[scale=0.6, clip, trim={1em 1em 1em 1em}]{images/unterschrift}}{}\\ \cline{1-1}\cline{3-3}
   Datum && Unterschrift 
\end{tabular}
}
\newpage